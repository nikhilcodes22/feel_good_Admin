        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img 
                ...
                className="w-10 h-10"
              />
              <span className="font-display font-bold text-xl">FeelGood</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-primary-foreground/70 hover:text-primary-foreground text-sm transition-colors">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-sm text-primary-foreground/70">
                ...
                123 Volunteer Street,<br />San Francisco, CA 94102
              </li>
            </ul>
          </div>
        </div>
